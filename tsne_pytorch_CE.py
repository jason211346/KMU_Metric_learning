...
parser.add_argument('--data', default='/root/notebooks/nfs/work/jason.chen/project/triplet_loss/pytorch-triplet-loss/', type=str, help='path to dataset')
parser.add_argument('--cub', default='CUB_10', type=str, help='path to dataset')
parser.add_argument('--model_file', default='/root/notebooks/nfs/work/jason.chen/project/triplet_loss/pytorch-triplet-loss/SoftTriple/out_model/', type=str,
                    help='MN')
parser.add_argument('--model_path', default='CUB_10_CE/CUB_10_CE.pth', type=str,
                    help='Mp')
